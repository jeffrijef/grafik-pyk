<%@ page language="C#" autoeventwireup="true" inherits="LookUpMulti, App_Web_p4vdymow" %>
...
<body style="font-family: Trebuchet MS; font-size: 8pt">
  ...
  <table id="tblResult" cellpadding="2px" cellspacing="0" width="100%">
          ...
          <tr>
            <td colspan="4" align="left">
              <asp:GridView ID="ugvw_LookUp" runat="server" AutoGenerateColumns="False" Width="100%"
                OnPageIndexChanging="ugvw_LookUp_PageIndexChanging" 
                OnRowCreated="ugvw_LookUp_RowCreated" CellPadding="4" AllowPaging="True" ForeColor="#333333"
                CssClass="grvmaster" EmptyDataText="Tidak ditemukan data pada database">
                <Columns>
    ...
    <tr>
      <td align="left">
        <asp:Button ID="ubtn_Select" runat="server" CssClass="btnmaster" Text="Search" OnClick="ubtn_Select_Click" />
      </td>
    </tr>
  </table>
  </form>
