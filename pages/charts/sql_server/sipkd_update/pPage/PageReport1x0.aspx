<%@ page language="C#" masterpagefile="~/List0.master" autoeventwireup="true" inherits="pPageReport1x0, App_Web_oselwu5t" %>
...
<asp:Content ID="ucon_list" ContentPlaceHolderID="ucon_Master_List" runat="Server">
  <mwa:UpdatePanel ID="upnl_filter" runat="server" Mode="Always" EnableViewState="true"
    ...
    <ContentTemplate>
      ...
      <iframe runat="server" id="ifrm" name="ifrm" scrolling="auto" width="80%" height="500"
