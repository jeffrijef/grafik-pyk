<%@ page language="C#" masterpagefile="~/List.master" autoeventwireup="true" inherits="pSistem_Download2, App_Web_thj50hhy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ucon_Master_List" runat="Server">
  <asp:Panel ID="upnl_form_filter" runat="server" Width="100%" Visible="true">
    <asp:Panel ID="pnlUpload" runat="server">
      <table id="Table1" cellspacing="0" cellpadding="0" class="tblhat75">
        <tr>
          <td colspan="3" align="center">
            <table id="utbl_form1" cellspacing="0" cellpadding="0" style="width: 100%" />
              <tr>
        ...
        <tr>
          ...
          <td class="tdinput">
            <input type="file" id="File1" runat="server" style="width: 65%" />
          </td>
        </tr>
        <tr>
          ...
          <tr>
            <td>
              <asp:GridView ID="ugrv_list" runat="server" CellPadding="3" runat="server" PageSize="10"
                ...
                <Columns>
                  <asp:ButtonField HeaderText="Nama Dokumen" DataTextField="Name" ItemStyle-Width="30%"
