<%@ page language="C#" masterpagefile="~/List.master" autoeventwireup="true" inherits="pSistem_Konfigurasi3, App_Web_thj50hhy" title="Transfer DPA" %>
        ...
        <tr>
          <td style="height: 300px;" align="center">
            ...
            <table id="utbl_Status" class="tbllogin" style="width: 50%">
              ...
              <tr>
                <td class="tdlabellist">
                  <asp:Label ID="Label2" runat="server" Text="Tanggal"></asp:Label>
                </td>
                <td class="tdinput" colspan="3">
                  <ew:CalendarPopup id="ucal_Tgl" runat="server" DisableTextBoxEntry="False" CssClass="txtmaster" Visible="true" DayNameFormat="FirstTwoLetters" NullableLabelText="Pilih Tanggal"></ew:CalendarPopup>
                </td>
              </tr>
              ...
              <asp:Panel ID="upnl_tahap" runat="server" Visible="false">
                <tr  class="trhide">
                  <td class="tdlabellist">
