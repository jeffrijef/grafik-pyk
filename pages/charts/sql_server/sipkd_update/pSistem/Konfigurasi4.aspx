<%@ page language="C#" masterpagefile="~/List.master" autoeventwireup="true" inherits="pSistem_Konfigurasi4, App_Web_thj50hhy" title="Copy Kegiatan" %>
...
<%--              <tr>
                  <td class="tdlabellist" style="width: 18%">
                    <asp:Label ID="Label3" runat="server" Text="Tahun Sumber"></asp:Label>
                  </td>
                  <td class="tdinput" colspan="3">
                    <asp:DropDownList ID="uddl_TahunFrom" runat="server" CssClass="ddlmaster" OnSelectedIndexChanged="uddl_Tahun_SelectedIndexChanged"
                      AutoPostBack="True">
                    </asp:DropDownList>
                  </td>
               </tr>--%>
              ...
              <tr>
                <td class="tdlabellist">
                  <asp:Label ID="Label2" runat="server" Text="Unit Sumber"></asp:Label>
                </td>
              ...
              <tr class="trhide">
                ...
                <td class="tdinput" colspan="3">
                  <asp:TextBox ID="utxt_Kdkegunit" runat="server" CssClass="txtmaster"></asp:TextBox>
                </td>
              </tr>
              <tr>
                <td class="tdlabellist">
                  <asp:Label ID="Label4" runat="server" Text="Kegiatan Sumber"></asp:Label>
                </td>
                <td colspan="3" class="tdinput">
                  <asp:TextBox ID="utxt_Nukeg" runat="server" CssClass="txtmaster" ReadOnly="True"
                    Width="15%"></asp:TextBox>
                  <asp:Image ID="ubtn_Lookup_keg" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Images/IconAdvSearch_old.gif" />
                  <asp:TextBox ID="utxt_Nmkegunit" runat="server" CssClass="txtmaster" ReadOnly="True"
                    Width="70%"></asp:TextBox>
                </td>
              </tr> 
              <td class="tdhat" style="height: 20px">
...
<%--              <tr>
                  <td class="tdlabellist">
                    <asp:Label ID="Label6" runat="server" Text="Tahun Tujuan"></asp:Label>
                  </td>
                  <td class="tdinput" colspan="3">
                    <asp:DropDownList ID="uddl_Tahun" runat="server" CssClass="ddlmaster" OnSelectedIndexChanged="uddl_Tahun_SelectedIndexChanged"
                      AutoPostBack="True">
                    </asp:DropDownList>
                  </td>
               </tr>--%>
<%--              <tr class="trhide">
                ...
                <td class="tdinput" colspan="3">
                  <asp:TextBox ID="utxt_Unitkey2" runat="server" CssClass="txtmaster"></asp:TextBox>
                </td>
              </tr>
              <tr>
                <td class="tdlabellist">
                  <asp:Label ID="Label1" runat="server" Text="Unit Tujuan"></asp:Label>
                </td>
                <td colspan="3" class="tdinput">
                  <asp:TextBox ID="utxt_Kdunit2" runat="server" CssClass="txtmaster" ReadOnly="True"
                    Width="15%"></asp:TextBox>
                  <asp:ImageButton ID="ubtn_Lookup_unit2" runat="server" ImageAlign="AbsMiddle" 
                        ImageUrl="~/Images/IconAdvSearch_old.gif" OnClick="lookup_unit2_Click"/>
                  <asp:TextBox ID="utxt_Nmunit2" runat="server" CssClass="txtmaster" ReadOnly="True"
                    Width="70%"></asp:TextBox>
                </td>
              </tr>--%>
              <tr class="trhide">
                ...
                <td class="tdinput" colspan="3">
                  <asp:TextBox ID="utxt_Kdkegunit2" runat="server" CssClass="txtmaster"></asp:TextBox>
                </td>
              </tr>
              <tr>
                <td class="tdlabellist">
                  <asp:Label ID="Label7" runat="server" Text="Kegiatan Tujuan"></asp:Label>
                </td>
                <td colspan="3" class="tdinput">
                  <asp:TextBox ID="utxt_Nukeg2" runat="server" CssClass="txtmaster" ReadOnly="True"
                    Width="15%"></asp:TextBox>
                  <asp:Image ID="ubtn_Lookup_keg2" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Images/IconAdvSearch_old.gif" />
                  <asp:TextBox ID="utxt_Nmkegunit2" runat="server" CssClass="txtmaster" ReadOnly="True"
                    Width="70%"></asp:TextBox>
                </td>
              </tr> 
              <tr class="trhide">
              ...
              <asp:Panel ID="upnl_tahap" runat="server">
                ...
                <tr>--%>
                  ...
                  <td class="tdinput" colspan="3">
                    ...
                    <asp:CheckBox ID="uchk_Transfer" runat="server" CssClass="btnmaster" Text="Copy Kegiatan" />
