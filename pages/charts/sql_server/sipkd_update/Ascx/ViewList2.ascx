<%@ control language="C#" autoeventwireup="true" inherits="Ascx_ViewList2, App_Web_tfr0owwv" %>
...
<cc1:PagingGridView ID="ugrv_list" runat="server" CellPadding="3" BackColor="White"
  BorderColor="#666666" BorderStyle="None" BorderWidth="1px" 
  AllowPaging="True" AutoGenerateColumns="False"
  EmptyDataText="Tidak ditemukan data pada database" CssClass="grvmaster" OnRowCommand="ugrv_list_RowCommand"
  OnRowCreated="ugrv_list_RowCreated" OnPageIndexChanging="ugrv_list_PageIndexChanging"
  OnRowEditing="ugrv_list_RowEditing" OnRowUpdating="ugrv_list_RowUpdating" 
  OnRowCancelingEdit="ugrv_list_RowCancelingEdit"
  OnRowDataBound="ugrv_list_RowDataBound" OnDataBound="ugrv_list_DataBound">
  <Columns>
    ...
    <asp:TemplateField HeaderText="C2" ShowHeader="False">
      <EditItemTemplate>
        ...
        <asp:DropDownList ID="uddl_Value2" runat="server" Visible="false">
        </asp:DropDownList>
      </EditItemTemplate>
      <ItemTemplate>
        ...
        <asp:TextBox ID="utxt_LabelVal2" runat="server" BorderWidth="0" BorderStyle="None"
          Visible="false" TextMode="MultiLine" ReadOnly="true" Style="overflow: hidden; width: 100%;
          height: auto" CssClass="expanding"></asp:TextBox>
      </ItemTemplate>
      <FooterTemplate>
    ...
    <asp:TemplateField HeaderText="C3" ShowHeader="False">
      <EditItemTemplate>
        ...
        <asp:DropDownList ID="uddl_Value3" runat="server" Visible="false">
        </asp:DropDownList>
      </EditItemTemplate>
      <ItemTemplate>
        ...
        <asp:TextBox ID="utxt_LabelVal3" runat="server" BorderWidth="0" BorderStyle="None"
          Visible="false" TextMode="MultiLine" ReadOnly="true" Style="overflow: hidden; width: 100%;
          height: auto" CssClass="expanding"></asp:TextBox>
      </ItemTemplate>
      <FooterTemplate>
    ...
    <asp:TemplateField HeaderText="C4" ShowHeader="False">
      <EditItemTemplate>
        ...
        <asp:DropDownList ID="uddl_Value4" runat="server" Visible="false">
        </asp:DropDownList>
      </EditItemTemplate>
      <ItemTemplate>
        ...
        <asp:TextBox ID="utxt_LabelVal4" runat="server" BorderWidth="0" BorderStyle="None"
          Visible="false" TextMode="MultiLine" ReadOnly="true" Style="overflow: hidden; width: 100%;
          height: auto" CssClass="expanding"></asp:TextBox>
      </ItemTemplate>
      <FooterTemplate>
    ...
    <asp:TemplateField HeaderText="C5" ShowHeader="False">
      <EditItemTemplate>
        ...
        <asp:DropDownList ID="uddl_Value5" runat="server" Visible="false">
        </asp:DropDownList>
      </EditItemTemplate>
      <ItemTemplate>
        ...
        <asp:TextBox ID="utxt_LabelVal5" runat="server" BorderWidth="0" BorderStyle="None"
          Visible="false" TextMode="MultiLine" ReadOnly="true" Style="overflow: hidden; width: 100%;
          height: auto" CssClass="expanding"></asp:TextBox>
      </ItemTemplate>
      <FooterTemplate>
    ...
    <asp:TemplateField HeaderText="C6" ShowHeader="False">
      <EditItemTemplate>
        ...
        <asp:DropDownList ID="uddl_Value6" runat="server" Visible="false">
        </asp:DropDownList>
      </EditItemTemplate>
      <ItemTemplate>
        ...
        <asp:TextBox ID="utxt_LabelVal6" runat="server" BorderWidth="0" BorderStyle="None"
          Visible="false" TextMode="MultiLine" ReadOnly="true" Style="overflow: hidden; width: 100%;
          height: auto" CssClass="expanding"></asp:TextBox>
      </ItemTemplate>
      <FooterTemplate>
    ...
    <asp:TemplateField HeaderText="C7" ShowHeader="False">
      <EditItemTemplate>
        ...
        <asp:DropDownList ID="uddl_Value7" runat="server" Visible="false">
        </asp:DropDownList>
      </EditItemTemplate>
      <ItemTemplate>
        ...
        <asp:TextBox ID="utxt_LabelVal7" runat="server" BorderWidth="0" BorderStyle="None"
          Visible="false" TextMode="MultiLine" ReadOnly="true" Style="overflow: hidden; width: 100%;
          height: auto" CssClass="expanding"></asp:TextBox>
      </ItemTemplate>
      <FooterTemplate>
    ...
    <asp:TemplateField HeaderText="C8" ShowHeader="False">
      <EditItemTemplate>
        ...
        <asp:DropDownList ID="uddl_Value8" runat="server" Visible="false">
        </asp:DropDownList>
      </EditItemTemplate>
      <ItemTemplate>
        ...
        <asp:TextBox ID="utxt_LabelVal8" runat="server" BorderWidth="0" BorderStyle="None"
          Visible="false" TextMode="MultiLine" ReadOnly="true" Style="overflow: hidden; width: 100%;
          height: auto" CssClass="expanding"></asp:TextBox>
      </ItemTemplate>
      <FooterTemplate>
    ...
    <asp:TemplateField HeaderText="C9" ShowHeader="False">
      <EditItemTemplate>
        ...
        <asp:DropDownList ID="uddl_Value9" runat="server" Visible="false">
        </asp:DropDownList>
      </EditItemTemplate>
      <ItemTemplate>
        ...
        <asp:TextBox ID="utxt_LabelVal9" runat="server" BorderWidth="0" BorderStyle="None"
          Visible="false" TextMode="MultiLine" ReadOnly="true" Style="overflow: hidden; width: 100%;
          height: auto" CssClass="expanding"></asp:TextBox>
      </ItemTemplate>
      <FooterTemplate>
    ...
    <asp:TemplateField HeaderText="C10" ShowHeader="False">
      <EditItemTemplate>
        ...
        <asp:DropDownList ID="uddl_Value10" runat="server" Visible="false">
        </asp:DropDownList>
      </EditItemTemplate>
      <ItemTemplate>
        ...
        <asp:TextBox ID="utxt_LabelVal10" runat="server" BorderWidth="0" BorderStyle="None"
          Visible="false" TextMode="MultiLine" ReadOnly="true" Style="overflow: hidden; width: 100%;
          height: auto" CssClass="expanding"></asp:TextBox>
      </ItemTemplate>
      <FooterTemplate>
    ...
    <asp:TemplateField>
      <HeaderTemplate>
        <%--<asp:CheckBox ID="uchk_hdelete" runat="server" AutoPostBack="True" OnCheckedChanged="uchk_hdelete_CheckedChanged"/>--%>
...
--%>
<div style="position: absolute; top: -10000px; left: -10000px; width: 300px; font-size: 13px;
