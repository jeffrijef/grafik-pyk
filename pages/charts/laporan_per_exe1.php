...
if ($b == 'A') {
	...
	$nama = 'Pajak Reklame';
	$query_bayar1 = "select nm_reklame as nm_usaha,a.pokok_pajak from reklame.pembayaran as a inner join reklame.skp as b on a.no_urut_surat=b.no_urut_surat and a.thn_pajak=b.thn_pajak and a.bln_pajak=b.bln_pajak where a.tgl_bayar >= '$tgl1' and a.tgl_bayar <= '$tgl2'";
}else if ($b == 'C'){
	$nama = 'Pajak Restoran';
	$query_bayar1 = "select * from restoran.pembayaran as a inner join restoran.sptpd as b on a.no_urut_surat=b.no_urut_surat and a.thn_pajak=b.thn_pajak and a.bln_pajak=b.bln_pajak where a.tgl_bayar >= '$tgl1' and a.tgl_bayar <= '$tgl2'";
}else if ($b == 'D'){
	$nama = 'Pajak Penerangan Jalan';
	$query_bayar1 = "select * from ppj.pembayaran as a inner join ppj.sptpd as b on a.no_urut_surat=b.no_urut_surat and a.thn_pajak=b.thn_pajak and a.bln_pajak=b.bln_pajak where a.tgl_bayar >= '$tgl1' and a.tgl_bayar <= '$tgl2'";
}else if ($b == 'E'){
	$nama = 'Pajak Parkir';
	$query_bayar1 = "select * from parkir.pembayaran as a inner join parkir.sptpd as b on a.no_urut_surat=b.no_urut_surat and a.thn_pajak=b.thn_pajak and a.bln_pajak=b.bln_pajak where a.tgl_bayar >= '$tgl1' and a.tgl_bayar <= '$tgl2'";
}else if ($b == 'F'){
	$nama = 'Pajak Hiburan';
	$query_bayar1 = "select * from hiburan.pembayaran as a inner join hiburan.sptpd as b on a.no_urut_surat=b.no_urut_surat and a.thn_pajak=b.thn_pajak and a.bln_pajak=b.bln_pajak where a.tgl_bayar >= '$tgl1' and a.tgl_bayar <= '$tgl2'";
}else if ($b == 'G'){
	$nama = 'Pajak Hotel';
	$query_bayar1 = "select * from hotel.pembayaran as a inner join hotel.sptpd as b on a.no_urut_surat=b.no_urut_surat and a.thn_pajak=b.thn_pajak and a.bln_pajak=b.bln_pajak where a.tgl_bayar >= '$tgl1' and a.tgl_bayar <= '$tgl2'";
}else if ($b == 'H'){
	$nama = 'Pajak PMBLB';
	$query_bayar1 = "select * from galianc.pembayaran as a inner join galianc.sptpd as b on a.no_urut_surat=b.no_urut_surat and a.thn_pajak=b.thn_pajak and a.bln_pajak=b.bln_pajak where a.tgl_bayar >= '$tgl1' and a.tgl_bayar <= '$tgl2'";
}else if ($b == 'I'){
	$nama = 'Pajak BPHTB';
	$query_bayar1 = "select nama_sppt as nm_usaha,pokok_pajak from bphtb.pembayaran as a inner join bphtb.sspd as b on a.no_urut_surat=b.no_urut_surat and a.thn_pajak=b.thn_pajak and a.bln_pajak=b.bln_pajak where a.tgl_bayar >= '$tgl1' and a.tgl_bayar <= '$tgl2'";
}else if ($b == 'J'){
...
foreach ($myPDO->query($query_bayar1) as $row) {
	$html .= '<tr><td>'.$i.'.</td><td> '.$row['nm_usaha'].'</td><td> Rp. '.number_format($row['pokok_pajak'],2).'</td></tr>';
	$i++;
}
}else if( $b == 'J' || $b == 'K' || $b == 'L'){
